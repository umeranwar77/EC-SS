...
def vehicle_detection(frame, license_plate,status,detection_type, cropedframe=None):
    try:
                                                        ...
                                                        if detection_type == '1':  
                                                            if last_record and last_record.detection_type == '1' and last_record.check_out_time is None:
                                                                ...
                                                                if time_difference >= 12:
                                                                    last_record.check_out_miss = True  # Mark previous record as missed checkout
                                                                    last_record.save()
