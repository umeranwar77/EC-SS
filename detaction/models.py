...
class CameraConfig(models.Model):
    ...
    camera_type=models.CharField(max_length=1,choices=DETECTION_CHOICES,default='1')
    def save(self, *args, **kwargs):
        self.generated_url = f"rtsp://{self.username}:{self.password}@192.168.100.70:554/cam/realmonitor?channel={self.channel_name}&subtype=1"
